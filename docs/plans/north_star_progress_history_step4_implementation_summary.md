...
- Changes: Progress updates now record a timestamped history entry alongside the existing progress update, coalescing updates within 60 seconds into the latest entry and ignoring future-dated rows when selecting the coalesce target.
