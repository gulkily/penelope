...
- Changes: replace the drag handle label with a grip graphic, style drag state, add touch-friendly handling, and include an `aria-live` announcer for reorder updates.
